...
export const zh = {
  ...
  whyKeyMissing: '这个后端需要一个 API 密钥。',
  keyLabel: 'API 密钥',
  keyPlaceholder: '粘贴你的密钥',
  keySave: '保存',
  onboardingHeading: '先连接一个 AI',
  onboardingBody: '连接之后才能开始对话。可以稍后在“设置 → 连接”里更改。',
...
export const en: Record<ConnectionsLocaleKey, string> = {
  ...
  whyKeyMissing: 'This one needs an API key.',
  keyLabel: 'API key',
  keyPlaceholder: 'Paste your key',
  keySave: 'Save',
  onboardingHeading: 'Connect an AI to get started',
  onboardingBody: 'You need one connection before you can start a conversation. You can change this later under Settings → Connections.',
