...
export const en = {
  ...
  defaultModelHint: 'The model new chats start from when this provider is selected.',
  baseUrlLabel: 'Base URL',
  baseUrlAdapter: 'Provider default',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  defaultModelHint: '选中该提供方时，新对话从这个模型开始。',
  baseUrlLabel: '接口地址',
  baseUrlAdapter: '提供方默认',
  customRoute: 'Provider ID',
