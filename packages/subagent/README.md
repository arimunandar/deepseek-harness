...
| [`subagent-worktree-in-process/`](subagent-worktree-in-process/README.md) | Starts a fresh in-process child in its own git worktree | registers on `ctx.subagents` |
