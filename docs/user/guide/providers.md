...
- **`MODEL_NOT_ENTITLED`** — The key works and the route serves the model, but the account is not permitted to use it. Request access for the account or project, or select a model it may use; adding the model to the route changes nothing.
