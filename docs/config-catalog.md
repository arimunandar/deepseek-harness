...
Requires: `authorization` · `credentials` · `llm` · `agentDefaultModel`
...
Source: [`packages/credentials/connections/src/index.ts:106`](../packages/credentials/connections/src/index.ts)
