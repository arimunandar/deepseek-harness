...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/credentials/connections': { kind: 'indirect', reason: 'The directory answers a configuration question; the backend a person connects owns every model-visible surface once selected.' },
  ...
  'packages/client/ui-settings-connections': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
