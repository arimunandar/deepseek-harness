...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ConnectionOutcome: 'sign-in attempt result is owned by packages/credentials/connections/README.md',
  ConnectionNotice: 'sign-in conversation frame is owned by packages/credentials/connections/README.md',
  ConnectionPrompt: 'sign-in question frame is owned by packages/credentials/connections/README.md',
  ConnectionView: 'connection directory row is owned by packages/credentials/connections/README.md',
